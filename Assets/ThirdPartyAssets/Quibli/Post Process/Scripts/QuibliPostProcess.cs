...
public class QuibliPostProcess : ScriptableRendererFeature {
    ...
    // URP 17 no longer exposes SetupRenderPasses as an override point.
    public void SetupRenderPassesLegacy(ScriptableRenderer renderer, in RenderingData renderingData) {
#else
...
#if UNITY_6000_0_OR_NEWER
        // Quibli's optional post stack still targets URP compatibility mode.
        // Material shaders remain fully usable; skip legacy camera target setup.
        return;
#else
#if UNITY_2022_1_OR_NEWER
