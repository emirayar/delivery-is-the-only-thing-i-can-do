...
public class CompoundPass : ScriptableRenderPass {
    ...
    // URP 17 removed the legacy Execute override in favour of RenderGraph.
    // Keep Quibli's compatibility implementation available without attempting
    // to override an API that no longer exists.
    public void ExecuteLegacy(ScriptableRenderContext context, ref RenderingData renderingData) {
    }
#else
